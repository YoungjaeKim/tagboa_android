package net.tagboa.app.view.listview;
...
//	private ProgressBar blink;
	...
	private void init(){
		...
		footerContainer = LayoutInflater.from(getContext()).inflate(R.layout.load_more_footer, null);
		footer = (RelativeLayout) footerContainer.findViewById(R.id.load_more_footer);

		image = (ImageView) header.findViewById(R.id.ptr_id_image);
//		blink = (ProgressBar) header.findViewById(R.id.ptr_id_blink);
